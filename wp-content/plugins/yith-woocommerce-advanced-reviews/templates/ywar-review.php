	...
	<div id="comment-<?php echo $review->ID; ?>" class="comment_container">
		...
		<div class="comment-text">
			...
			<?php else : ?>
				...
				<p class="meta">
					<strong itemprop="author"><?php if(!is_numeric($author_name)){ echo $author_name; } else { echo 'Verified User';} ?>&nbsp;<img src="https://awesomedairy.com/wp-content/themes/awesomedairy/img/Twitter-Bluetick.jpg" style="height: 17px;"></strong> <?php
