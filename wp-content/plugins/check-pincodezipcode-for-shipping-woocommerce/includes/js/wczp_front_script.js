...
jQuery(document).ready(function() {
    ...
    jQuery("body").on('click', '.wczpbtn', function() {
        ...
        var popup_zipcode=postcode.toString().length;
        if(postcode != '' && popup_zipcode == 6) {
    ...
    jQuery("body").on('click', '.wczpinzipsubmit', function() {
        ...
        var popup_zipcode=popup_postcode.toString().length;
        if(popup_postcode != '' && popup_zipcode == 6) {
            jQuery('.wczp_empty').css('display', 'none');
