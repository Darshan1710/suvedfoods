...
if (!class_exists('WCZP_menu')) {
    class WCZP_menu {
        ...
        function WCZP_admin_menu() {
            add_menu_page(
                __( 'Add Post codes', 'check-pincodezipcode-for-shipping-woocommerce' ),
                __( 'Add Post codes', 'check-pincodezipcode-for-shipping-woocommerce' ),
                'manage_options',
                'post-code',
            ...
            add_submenu_page( 
                'post-code', 
                __( 'Import Post codes', 'check-pincodezipcode-for-shipping-woocommerce' ), 
                __( 'Import Post codes', 'check-pincodezipcode-for-shipping-woocommerce' ),
                'manage_options', 
                'post-code-import',
            ...
            add_submenu_page( 
                'post-code', 
                __( 'List Post codes', 'check-pincodezipcode-for-shipping-woocommerce' ), 
                __( 'List Post codes', 'check-pincodezipcode-for-shipping-woocommerce' ),
                'manage_options', 
                'post-code-list',
            ...
            add_submenu_page( 
                'post-code', 
                __( 'Settings', 'check-pincodezipcode-for-shipping-woocommerce' ),  
                __( 'Settings', 'check-pincodezipcode-for-shipping-woocommerce' ),
                'manage_options', 
                'post-code-setting',
                ...
                <div class="wczp_container">
                    <form method="post" class="oc_wczp">
                        ...
                        <table class="wczp_table">
                            ...
                            <tr class="wczp_color_tr">
                                <td>Check Input Box Text Color</td>
                                <td>
                                    <input type="text" class="color-picker" data-alpha="true" data-default-color="<?php echo get_option( 'wczp_check_ibox_text_clr', '#ffffff' ); ?>" name="wczp_check_ibox_text_clr" value="<?php echo get_option( 'wczp_check_ibox_text_clr', '#ffffff' ); ?>"/>
                                </td>
                            </tr>
                            <tr class="wczp_color_tr">
                            ...
                            <tr class="wczp_nosrvtxt">
                                ...
                                <td>
                                    <input type="text" name="wczp_availability_label_txt" value="<?php echo get_option('wczp_availability_label_txt', 'Where would you like us to deliver?'); ?>" >
                                    <label class="wczp_pro_link">Only available in pro version <a href="https://www.xeeshop.com/product/check-pincode-zipcode-for-shipping-woocommerce-pro/" target="_blank">link</a></label>
                                </td>
                            </tr>
                            <tr class="wczp_nosrvtxt">
                                <td>Check Availability At Valid City/State Message</td>
                                <td>
                                    <input type="text" name="wczp_availability_citystate" value="YES, We Deliver to {city_name}, {state_name}" >
                                    <label class="wczp_pro_link">Only available in pro version <a href="https://www.xeeshop.com/product/check-pincode-zipcode-for-shipping-woocommerce-pro/" target="_blank">link</a></label>
                                    <p class="wczp_scode_info"><strong>{city_name}</strong> to your pincode city name and <strong>{state_name}</strong> to your pincode state name</p>
                                </td>
                            </tr>
                            <tr>
                ...
                if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'WCZP_settings_save') {
                    if(!isset( $_POST['wczp_nonce_field'] ) || !wp_verify_nonce( $_POST['wczp_nonce_field'], 'wczp_nonce_action' )) {
                        ...
                        update_option( 'wczp_check_ibox_bg_clr', sanitize_text_field( $_REQUEST['wczp_check_ibox_bg_clr']));
                         update_option( 'wczp_check_ibox_text_clr', sanitize_text_field( $_REQUEST['wczp_check_ibox_text_clr']));
...
class WCZP_List_Table extends WP_List_Table {
    ...
    public function get_bulk_actions() {
        return array(
            'delete' => __( 'Delete', 'check-pincodezipcode-for-shipping-woocommerce' ),
        );
    }
