...
if (!class_exists('WCZP_front')) {
    ...
    class WCZP_front {
        ...
        function WCZP_pincode_check($pincode){
            global $wpdb;
        ...
        function WCZP_before_add_to_cart_btn() {
            ...
            $wczp_check_ibox_text_clr = get_option( 'wczp_check_ibox_text_clr', '#ffffff' );
            ...
            $wczp_delivery_date_txt= get_option('wczp_delivery_date_txt', 'Delivery Date');
            ...
            <div class="wczpc_maindiv" style="background-color: <?php echo $box_backgrond_clr; ?>;padding: 10px 0px;">
                    ...
                    <div class="response_pin">
                        <?php 
                            if(isset($_COOKIE['wczp_postcode'])) {
                                $pincode = sanitize_text_field($_COOKIE['wczp_postcode']);
                                $record = $this->WCZP_pincode_check($pincode);
                                ...
                                if ($totalrec == 1) {
                                    ...
                                    if($showdate == "on") {
                                        ...
                                        echo '<div class="wczp_avaddate"><p>'.$wczp_delivery_date_txt.'</p><span>'.$deliverydate.'</span></div></div>';
                                    }
                                    ...
                                    $available_message1 = "YES, We Deliver to";
                                    $available_message2 = $available_message1;

                                    ?>
                                    <div class="pincode_city_and_state"><?php echo $available_message2;?>&nbsp;&nbsp;<strong><span class="wczp_avaicode"><?php if(isset($_COOKIE['wczp_postcode']) && $_COOKIE['wczp_postcode'] != "no") { echo $_COOKIE['wczp_postcode']; } ?></span></strong> <span class="edit-pro-pin"><a  name="wczpbtn" class="wczpcheckbtn"><img src="https://cdn.shopify.com/s/files/1/0173/7644/4470/files/pen.png?453"></a></span></div>

                                    <?php
                                } else {
                                    echo $not_serviceable_text.'<span class="edit-pro-pin"><a  name="wczpbtn" class="wczpcheckbtn"><img src="https://cdn.shopify.com/s/files/1/0173/7644/4470/files/pen.png?453"></a></span>';
                                }
                            } 
                        ?>
                    </div>
                    <!-- <input type="button" name="wczpbtn" class="wczpcheckbtn" placeholder="Pincode" value="<?php echo $changetext; ?>" style="background-color: <?php echo $backgrond_clr; ?>;color: <?php echo $text_clr; ?>;"> -->
                ...
                <div class="wczp_cookie_check_div" style="display: <?php if(isset($_COOKIE['wczp_postcode'])  && $_COOKIE['wczp_postcode'] != "no") { echo "none"; } else { echo "flex"; } ?>;background-color: <?php echo $wczp_check_ibox_bg_clr; ?>;">
                    ...
                    <input type="number" name="wczpcheck" class="wczpcheck" placeholder="Pincode" value="<?php if(isset($_COOKIE['wczp_postcode']) && sanitize_text_field($_COOKIE['wczp_postcode']) != "no") { echo sanitize_text_field($_COOKIE['wczp_postcode']); } ?>" style="background-color: <?php echo $wczp_check_ibox_bg_clr; ?>; color: <?php echo $wczp_check_ibox_text_clr; ?>;">
          ...
          $codtxt = "<p>".$cash_on_delivary_text."</p><span>".$cod_avail."</span>";
            ...
            if($totalrec == 1) {
                ...
                if($showdate == "on") {
                    ...
                    $avai_msg .= '<div class="wczp_avaddate"><p>'.$wczp_delivery_date_txt.'</p><span>'.$deliverydate.'</span></div></div>';
                }
                ...
                if($wczp_cash_dilivery_shw == "on") {
                    ...
                    </svg></span><div class="wczp_avacod">'.$codtxt.'</div></div>';
                }
                $available_message1 = str_replace("{city_name}","<strong>".$record[0]->wczp_city."</strong>","YES, We Deliver to {city_name}, {state_name}");
                $available_message2 = "YES, We Deliver to";
                $avai_msg .= '<div class="pincode_city_and_state">'.$available_message2.'&nbsp;<strong><span class="wczp_avaicode">'.$_COOKIE['wczp_postcode'].'</span></strong> <span class="edit-pro-pin"><a  name="wczpbtn" class="wczpcheckbtn"><img src="https://cdn.shopify.com/s/files/1/0173/7644/4470/files/pen.png?453"></a></span></div>';
            }
                        ...
                        <div class="modal-content" style="background-color:<?php echo $wczp_cpin_pp_bg_clr; ?>">
                            ...
                            <div class="modalinner">
                                <div class="popup_oc_main" style="color:<?php echo $wczp_cpin_pp_txt_clr; ?>; background-color:<?php echo $wczp_cpin_pp_bg_clr; ?>">
                                    ...
                                    <h4 class="wczp_popup_header" style="color:<?php echo $wczp_cpin_pp_txt_clr; ?>;">Check your location availability info</h4>
                                ...
                                <div class="response_pin_popup">
                                    <?php    
                                        if(isset($_COOKIE['wczp_postcodee'])) {
                                            $pincode = sanitize_text_field($_COOKIE['wczp_postcodee']);
                                            $record = $this->WCZP_pincode_check($pincode);
                                            $totalrec = count($record);
                                            ...
                                            if ($totalrec == 1) {
                                                ...
                                                echo 'We are available currently servicing your area'.'<span class="edit-pro-pin"><a  name="wczpbtn" class="wczpcheckbtn"><img src="https://cdn.shopify.com/s/files/1/0173/7644/4470/files/pen.png?453"></a></span>';
                                            } else {
                                                echo $not_serviceable_text.'<span class="edit-pro-pin"><a  name="wczpbtn" class="wczpcheckbtn"><img src="https://cdn.shopify.com/s/files/1/0173/7644/4470/files/pen.png?453"></a></span>';
                                            }
                                        } 
        ...
        function WCZP_popup_check_zip_code() {
            ...
            $record = $this->WCZP_pincode_check($popup_postcode);
            $totalrec = count($record);
            $data = array();
            $data = array(
        ...
        function WCZP_woo_add_cart_fee() {
            ...
            if( get_option('wczp_enable_shipping_cost', 'on') == 'on' ){
                if(isset($_COOKIE['wczp_postcode'])) {
                    ...
                    $record = $this->WCZP_pincode_check($pincode);
                    //print_r( $record[0]);
                    if(isset($record[0]) && $record[0]->wczp_ship_amount != 0 && !empty($record[0]->wczp_ship_amount)){
