    ...
    class WCZP {
        ...
        function WCZP_plugin_row_meta( $links, $file ) {
            if ( WCZP_BASE_NAME === $file ) {
                $row_meta = array(
                    'rating'    =>  '<a href="https://www.xeeshop.com/check-pincode-zipcode-for-shipping-woocommerce/" target="_blank">Documentation</a> | <a href="https://www.xeeshop.com/support-us/?utm_source=aj_plugin&utm_medium=plugin_support&utm_campaign=aj_support&utm_content=aj_wordpress" target="_blank">Support</a> | <a href="https://wordpress.org/support/plugin/check-pincodezipcode-for-shipping-woocommerce/reviews/?filter=5" target="_blank"><img src="'.WCZP_PLUGIN_DIR.'/includes/images/star.png" class="wczp_rating_div"></a>',
                );
        ...
        function WCZP_load_front() {
            ...
            $not_serviceable_text = 'Oops! We are not currently servicing your area <span class="edit-pro-pin"><a  name="wczpbtn" class="wczpcheckbtn"><img src="https://cdn.shopify.com/s/files/1/0173/7644/4470/files/pen.png?453"></a></span>';
