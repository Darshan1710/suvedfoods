		...
		<div id="top-header"<?php echo $et_top_info_defined ? '' : 'style="display: none;"'; ?>>
			...
			<?php if ( $et_contact_info_defined ) : ?>
				...
				<?php if ( '' !== ( $et_email = et_get_option( 'header_email' ) ) ) : ?>
					...
					<span id="et-info-text"><span>Pan India Free shipping on all orders over Rs. 299 </span><a class="shipping-text" href="/shop/">Shop Now!</a><!--<a class="shipping-text" href="/shop/">Track your order</a></span>--->
				<?php endif; ?>
