...
function add_percentage_to_sale_badge( $html, $post, $product ) {
    ...
    return '<span class="onsale">' . esc_html__( 'DISCOUNT', 'woocommerce' ) . ' ' . $percentage . '</span>';
}
...
function add_loginout_link( $items, $args ) {
  if (is_user_logged_in() && $args->theme_location == 'primary-menu') {
    ...
    $items .= '<li id="account mega-menu-item-120" class="mega-menu-item mega-menu-item-type-custom mega-menu-item-object-custom mega-menu-item-has-children mega-align-bottom-left mega-menu-flyout"><a class="mega-menu-link" href="https://suvedfoods.com/my-account/" aria-current="page">
                            <i class="fa fa-user-circle"></i>&nbsp;&nbsp;Hi, '.$firstname.'&nbsp;<i class="fas fa-caret-down"></i></a> <ul class="mega-sub-menu">
                            <li class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-1583"><a class="mega-menu-link" href="https://suvedfoods.com/my-account" style="color:#041831;" aria-current="page"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;My Account</a></li>
                            <li  class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-1583"><a class="mega-menu-link" href="'.wp_logout_url( get_permalink() ).'"  style="color:#041831;" aria-current="page"><i class="fa fa-sign-out" aria-hidden="true"></i>&nbsp;&nbsp;Logout</a></li>
                            </ul></li>';
  }
   elseif (!is_user_logged_in() && $args->theme_location == 'primary-menu') {
    $items .= '<li class="mega-menu-item mega-menu-item-type-custom mega-menu-item-object-custom mega-menu-item-has-children mega-align-bottom-left mega-menu-flyout"><a class="mega-menu-link" href="' . get_permalink( wc_get_page_id( 'myaccount' ) ) . '">Sign In / Sign Up</a></li>';
  }
   return $items;
}
